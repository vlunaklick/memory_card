...
function Main({increment,reset}){
    ...
    let cartas = perso.map(item => {
        return <PicturesT  handleClick={handleClick} key={item.id} src={item.src} name={item.name} id={item.id} />
    });
    ...
    return(
        ...
        <main className="mainCont"> 
            ...
            <h2 className="subtitle">You get a point if you select one you havent't yet</h2>
...
let personajes = [
    ...
    {src:"https://i.ytimg.com/vi/-aQ9xbVqjYw/maxresdefault.jpg",name:"Razor",id:"razor"},
];
